...
### Пользователям — готовая программа
Загляните на страницу [**Releases**](https://github.com/mineones047-ux/KoraDesctop/releases) — там
публикуется готовый установщик (`.exe` для Windows, `.dmg` для macOS, `.AppImage` для Linux). Если релиз
ещё не опубликован — используйте способ для разработчиков ниже.

### Разработчикам — исходный код
...
Без Git: откройте страницу репозитория, нажмите зелёную кнопку **Code → Download ZIP** и распакуйте архив.

Дальше — разделы «Требования» и «Установка» ниже.
